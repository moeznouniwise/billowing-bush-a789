...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "billowing-bush-a789-d1":

```bash
npx wrangler d1 create billowing-bush-a789-d1
```
